...
class App implements \ArrayAccess
{
	...
	protected function initialize()
	{
		...
		$container['config.default'] = [
			...
			'globalSalt' => 'bebb835573519224ee2d0848f0b2468f',
		...
		{
			$class = $this->extendClass('XF\CookieConsent');
		...
		$container['paymentProvider'] = $this->fromRegistry('paymentProvider',
			function(Container $c) { return $c['em']->getRepository('XF:Payment')->rebuildPaymentProviderCache(); }
		);
