 ...
 */
class Downloaded extends AbstractHandler
{
	/**
	 *
	 */
	...
	public function alertTemplate(TransactionEntity $transaction): string
	{
		...
		if ($which == 'spent')
		{
			return $this->getAlertPhrase('dbtech_credits_lost_x_y_via_resourcedownloaded', $transaction);
		}
		else
		{
			return $this->getAlertPhrase('dbtech_credits_gained_x_y_via_resourcedownloaded', $transaction);
		}
	}
