...
class Download extends AbstractHandler
{
	...
	public function alertTemplate(TransactionEntity $transaction): string
	{
		...
		if ($which == 'spent')
		{
			return $this->getAlertPhrase('dbtech_credits_lost_x_y_via_download', $transaction);
		}
		else
		{
			return $this->getAlertPhrase('dbtech_credits_gained_x_y_via_download', $transaction);
		}
	}
	...
	public function getLabels(): array
	{
		...
		$labels['owner_explain'] = \XF::phrase('dbtech_credits_event_owner_explain_attachment');
		$labels['owner_only_others'] = \XF::phrase('dbtech_credits_event_owner_only_others_attachment');
		$labels['owner_only_own'] = \XF::phrase('dbtech_credits_event_owner_only_own_attachment');
