...
class XF
{
	...
	public static $versionId = 2021770; // abbccde = a.b.c d (alpha: 1, beta: 3, RC: 5, stable: 7, PL: 9) e

	const XF_API_URL = 'https://xenforo.com/api/';
	const XF_LICENSE_KEY = '6zSGoAgdstI894OJPeCm2tKVu4jzsqpw';
	...
	{
		$composerAutoload = new \XF\ComposerAutoload(self::app(), $pathPrefix);
	 ...
	 * @return \XF\Entity\User
	 */
	public static function preRegActionUser(): \XF\Entity\User
	{
